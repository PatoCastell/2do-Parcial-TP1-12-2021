...
import ar.edu.ort.tp1.pacial2.clases.PizzaEspecial;
import ar.edu.ort.tp1.pacial2.clases.PizzaRectangular;
import ar.edu.ort.tp1.pacial2.clases.PizzaTradicional;
...
public class Parcial2 {
	...
	public static void main(String[] args) {
		...
		System.out.println("--------------------------------------");
		System.out.println("Cantidad de Pizzas pedidas entre $1000 y $2000?: " + (laPizzeria.vendidasConPrecioEntre(1000, 2000)));
	...
	private static void pedirTradicional(Pizzeria laPizzeria, String nombre, float costoBase, float porcentajeGanancia,
		...
		try{
			laPizzeria.ingresarPedido(new PizzaTradicional(nombre, costoBase, porcentajeGanancia, tipoDeMasa), topping);
		}catch(RuntimeException e) {
	...
	private static void pedirEspecial(Pizzeria laPizzeria, String nombre, float costoBase, float porcentajeGanancia,
		...
		try{
			laPizzeria.ingresarPedido(new PizzaEspecial(nombre, costoBase, porcentajeGanancia, cantidadFainas, tamanioDePizza),
					topping);
		}catch(RuntimeException e) {
			System.out.printf(MSG_ERROR, e.getMessage());
		}
	...
	private static void pedirRectangular(Pizzeria laPizzeria, String nombre, float costoBase, float porcentajeGanancia,
		...
		try{
			laPizzeria.ingresarPedido(new PizzaRectangular(nombre, costoBase, porcentajeGanancia, largo, ancho, adicionalQueso),
					topping);
		}catch(RuntimeException e) {
			System.out.printf(MSG_ERROR, e.getMessage());
		}
